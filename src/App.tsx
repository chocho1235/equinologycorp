    ...
    const revealCallback = (entries: IntersectionObserverEntry[]) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          // Removed auto-initialization of Waleed
        }
      });
    };
          ...
          <div className="max-w-6xl mx-auto relative">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 stagger-children">
              {[
                ...
                <div 
                  key={index}
                  className="bg-black/20 rounded-lg p-6 relative overflow-hidden hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300 hover:-translate-y-1"
                >
